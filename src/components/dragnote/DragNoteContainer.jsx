...
const mapDispatchToProps = (dispatch, props) => ({
  ...
  swapBuckets: (noteId, fromBucketId, toBucketId) =>
    dispatch(swapBuckets(noteId, fromBucketId, toBucketId)),
});
export default DragDropContext(HTML5Backend)(
  connect(mapStateToProps, mapDispatchToProps)(DragNoteContainer),
);
